...
#[derive(Debug)]
pub struct BlockUtilityProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockUtilityProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockUtility processing");
    
    let mut processor = BlockUtilityProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockUtilityProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockUtilityProcessor::new(false);
